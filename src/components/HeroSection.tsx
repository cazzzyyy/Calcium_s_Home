...
const HeroSection = () => {
  return (
    <div className="bg-gradient-to-br from-gray-100 to-gray-200 min-h-screen flex items-center justify-center p-8">
      <div className="max-w-4xl w-full flex flex-col md:flex-row items-center gap-8">
        {/* 左侧头像 */}
        <div className="flex-shrink-0">
          <img
            src="https://picsum.photos/seed/avatar123/200/200.jpg"
            alt="Profile"
